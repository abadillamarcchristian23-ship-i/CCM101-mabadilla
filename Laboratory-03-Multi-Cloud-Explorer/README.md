...
| Kernel           | Replace with actual `uname -r` output |
| CPU              | Replace with actual `lscpu` output    |
| Memory           | Replace with actual `free -h` output  |
| Disk Space       | Replace with actual `df -h` output    |
